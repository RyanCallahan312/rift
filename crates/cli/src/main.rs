...
enum Command {
    ...
    Init {
        ...
        #[arg(
            long,
            help = "Snapshot .git into Rift data storage and register future rifts as Git worktrees"
        )]
        worktrees: bool,
    },
    Create {
...
mod tests {
    ...
    #[test]
    fn init_command_accepts_worktrees_flag() {
        let cli = Cli::try_parse_from(["rift", "init", "--worktrees", "--here"]).unwrap();
